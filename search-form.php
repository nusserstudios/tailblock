<form role="search" method="get" class="search-form" action="<?php echo home_url( '/' ); ?>">
    ...
    <input type="submit" class="px-4 py-2 mt-2 font-bold text-white rounded bg-primary-500 search-submit hover:bg-primary-700" value="<?php _e( 'Search', 'your-text-domain' ); ?>" />
</form>
