(() => {
  ...
  // node_modules/.pnpm/preline@1.9.0/node_modules/preline/dist/preline.js
  var require_preline = __commonJS({
    "node_modules/.pnpm/preline@1.9.0/node_modules/preline/dist/preline.js"(exports, module) {
      !function(e, t) {
        ...
        return (() => {
          ...
          var e = { 661: (e2, t2, o2) => {
            ...
            function a(e3, t3) {
              if (t3 && (n2(t3) === "object" || typeof t3 == "function"))
                return t3;
              if (t3 !== void 0)
              ...
              return t3 = f, (o3 = [{ key: "init", value: function() {
                ...
                e4.length && (t4 = e4, function(e5) {
                  ...
                  if (e5) {
                    ...
                    return o5 === "Object" && e5.constructor && (o5 = e5.constructor.name), o5 === "Map" || o5 === "Set" ? Array.from(e5) : o5 === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(o5) ? r(e5, t5) : void 0;
                  }
                }(t4) || function() {
            ...
            function s(e3) {
              return function(e4) {
                ...
                if (e4) {
                  ...
                  return o3 === "Object" && e4.constructor && (o3 = e4.constructor.name), o3 === "Map" || o3 === "Set" ? Array.from(e4) : o3 === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(o3) ? c(e4, t3) : void 0;
                }
              }(e3) || function() {
                throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");
              }();
            ...
            function f(e3, t3) {
              if (t3 && (a(t3) === "object" || typeof t3 == "function"))
                return t3;
              if (t3 !== void 0)
                throw new TypeError("Derived constructors may only return object or undefined");
              return function(e4) {
              ...
              function d2() {
                ...
                return function(e5, t4) {
                  ...
                  return [{ name: "applyStyles", fn: function(t4) {
                    ...
                    t4.state.elements.popper.style.position = o4, t4.state.elements.popper.style.transform = n3 === "adaptive" ? t4.state.styles.popper.transform : null, t4.state.elements.popper.style.top = null, t4.state.elements.popper.style.bottom = null, t4.state.elements.popper.style.left = null, t4.state.elements.popper.style.right = null, t4.state.elements.popper.style.margin = 0;
              ...
              return t3 = d2, o3 = [{ key: "init", value: function() {
                ...
                document.addEventListener("click", function(t4) {
                  ...
                  if (n3 && n3.classList.contains("open") || e4._closeOthers(n3), r3) {
                    ...
                    if ((i2 == "false" || i2 == "inside") && !n3.parentElement.closest(e4.selector))
                      return;
                  }
                  ...
                  if (o4.closest(".hs-dropdown-menu"), n3) {
                    ...
                    if (r3 !== "hover")
                      return;
                    n3 && n3.classList.contains("open") || e4._closeOthers(n3), r3 !== "hover" || n3.classList.contains("open") || /iPad|iPhone|iPod/.test(navigator.platform) || navigator.maxTouchPoints && navigator.maxTouchPoints > 2 && /MacIntel/.test(navigator.platform) || navigator.maxTouchPoints && navigator.maxTouchPoints > 2 && /MacIntel/.test(navigator.platform) || e4._hover(o4);
                  }
                ...
                var e4 = this, t4 = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : null, o4 = document.querySelectorAll("".concat(this.selector, ".open"));
                o4.forEach(function(o5) {
                  if (!t4 || t4.closest(".hs-dropdown.open") !== o5) {
                    ...
                    n3 != "false" && n3 != "outside" && e4.close(o5);
                  }
                });
                ...
                var t4 = this, o4 = arguments.length > 1 && arguments[1] !== void 0 && arguments[1], n3 = e4.querySelector(".hs-dropdown-menu"), r3 = function() {
                ...
                if (r3 !== "static") {
                  ...
                  var a3 = (0, n2.fi)(e4, t4, { placement: this.positions[o4] || "bottom-start", strategy: r3, modifiers: [].concat(s(r3 !== "fixed" ? this.absoluteStrategyModifiers(e4) : []), [{ name: "offset", options: { offset: [0, i2] } }]) });
                  e4._popper = a3;
                }
                ...
                if (t4)
                  return e4.keyCode === 27 ? (e4.preventDefault(), this._esc(t4)) : e4.keyCode === 40 ? (e4.preventDefault(), this._down(t4)) : e4.keyCode === 38 ? (e4.preventDefault(), this._up(t4)) : e4.keyCode === 36 ? (e4.preventDefault(), this._start(t4)) : e4.keyCode === 35 ? (e4.preventDefault(), this._end(t4)) : void this._byChar(t4, e4.key);
                ...
                i2 === -1 && (this._history.clearHistory(), i2 = r3()), i2 !== -1 && (n3[i2].focus(), this._history.addHistory(i2));
              } }, { key: "toggle", value: function(e4) {
            ...
            var l = function(e3) {
              ...
              return t3 = f, (o3 = [{ key: "init", value: function() {
                var e4 = this;
                document.addEventListener("click", function(t4) {
                  var o4 = t4.target.closest(e4.selector), n4 = t4.target.closest("[data-hs-overlay-close]"), r2 = t4.target.getAttribute("aria-overlay") === "true";
                  ...
                  if (t4.keyCode === 27) {
                    ...
                    if (!o4)
                      return;
                    setTimeout(function() {
                      o4.getAttribute("data-hs-overlay-keyboard") !== "false" && e4.close(o4);
                    });
                  }
                });
              } }, { key: "toggle", value: function(e4) {
                ...
                var t4 = this;
                if (e4) {
                  var o4 = document.querySelector(".hs-overlay.open"), n4 = this.getClassProperty(e4, "--body-scroll", "false") !== "true";
                  if (o4)
                ...
                this.getClassProperty(e4, "--overlay-backdrop", "true") !== "static" && this.close(e4);
                ...
                var t4, o4 = this, n4 = e4.getAttribute("data-hs-overlay-backdrop-container") || false, i2 = document.createElement("div"), a2 = "transition duration fixed inset-0 z-50 bg-gray-900 bg-opacity-50 dark:bg-opacity-80 hs-overlay-backdrop", s2 = function(e5, t5) {
                  var o5 = typeof Symbol != "undefined" && e5[Symbol.iterator] || e5["@@iterator"];
                  if (!o5) {
                    if (Array.isArray(e5) || (o5 = function(e6, t6) {
                      if (e6) {
                        ...
                        return o6 === "Object" && e6.constructor && (o6 = e6.constructor.name), o6 === "Map" || o6 === "Set" ? Array.from(e6) : o6 === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(o6) ? r(e6, t6) : void 0;
                      }
                ...
                var l3 = this.getClassProperty(e4, "--overlay-backdrop", "true") !== "static";
                this.getClassProperty(e4, "--overlay-backdrop", "true") === "false" || (n4 && ((i2 = document.querySelector(n4).cloneNode(true)).classList.remove("hidden"), a2 = i2.classList, i2.classList = ""), l3 && i2.addEventListener("click", function() {
                  return o4.close(e4);
                ...
                document.querySelectorAll(this.selector).forEach(function(t4) {
                  ...
                  Array.from(r2).forEach(function(a2) {
                    ...
                    o5.addEventListener("click", function(n5) {
                      n5.preventDefault(), o5.getAttribute("href") !== "javascript:;" && e4._scrollTo({ $scrollspyEl: t4, $scrollableEl: i2, $link: o5 });
                    });
                  });
                });
              ...
              return function(e4) {
                ...
                if (e4) {
                  if (typeof e4 == "string")
                    return i(e4, t3);
                  var o3 = Object.prototype.toString.call(e4).slice(8, -1);
                  return o3 === "Object" && e4.constructor && (o3 = e4.constructor.name), o3 === "Map" || o3 === "Set" ? Array.from(e4) : o3 === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(o3) ? i(e4, t3) : void 0;
                }
              }(e3) || function() {
                throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");
              }();
            ...
            var u = function(e3) {
              ...
              return t3 = f, (o3 = [{ key: "init", value: function() {
                ...
                if (t4) {
                  var o4 = t4.closest('[role="tablist"]').getAttribute("data-hs-tabs-vertical") === "true";
                  return (o4 ? e4.keyCode === 38 : e4.keyCode === 37) ? (e4.preventDefault(), this._left(t4)) : (o4 ? e4.keyCode === 40 : e4.keyCode === 39) ? (e4.preventDefault(), this._right(t4)) : e4.keyCode === 36 ? (e4.preventDefault(), this._start(t4)) : e4.keyCode === 35 ? (e4.preventDefault(), this._end(t4)) : void 0;
                }
            ...
            function c(e3, t3) {
              if (t3 && (i(t3) === "object" || typeof t3 == "function"))
                return t3;
              if (t3 !== void 0)
                throw new TypeError("Derived constructors may only return object or undefined");
              return function(e4) {
            ...
            var u = function(e3) {
              ...
              return t3 = f, (o3 = [{ key: "init", value: function() {
                ...
                document.addEventListener("click", function(t4) {
                  var o4 = t4.target.closest(e4.selector);
                  o4 && e4.getClassProperty(o4, "--trigger") === "focus" && e4._focus(o4), o4 && e4.getClassProperty(o4, "--trigger") === "click" && e4._click(o4);
                }), document.addEventListener("mousemove", function(t4) {
                  var o4 = t4.target.closest(e4.selector);
                  o4 && e4.getClassProperty(o4, "--trigger") !== "focus" && e4.getClassProperty(o4, "--trigger") !== "click" && e4._hover(o4);
                });
              } }, { key: "_hover", value: function(e4) {
                var t4 = this;
            ...
            var r = function() {
              ...
              return t3 = e3, o3 = [{ key: "_fireEvent", value: function(e4) {
                ...
                var o4 = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : null, n3 = new CustomEvent(e4, { detail: { payload: o4 }, bubbles: true, cancelable: true, composed: false });
                t4.dispatchEvent(n3);
              } }, { key: "on", value: function(e4, t4) {
                this.events[e4] = t4;
              } }, { key: "afterTransition", value: function(e4, t4) {
                window.getComputedStyle(e4, null).getPropertyValue("transition") !== "all 0s ease 0s" ? e4.addEventListener("transitionend", function o4() {
                  t4(), e4.removeEventListener("transitionend", o4, true);
                }, true) : t4();
              } }, { key: "getClassProperty", value: function(e4, t4) {
                var o4 = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : "", n3 = (window.getComputedStyle(e4).getPropertyValue(t4) || o4).replace(" ", "");
                return n3;
            ...
            function a(e3) {
              return typeof ShadowRoot != "undefined" && (e3 instanceof n2(e3).ShadowRoot || e3 instanceof ShadowRoot);
            }
            o2.d(t2, { fi: () => ce });
            ...
            function m(e3, t3, o3) {
              ...
              return (s2 || !s2 && !o3) && ((p(t3) !== "body" || v(h2)) && (b2 = (r2 = t3) !== n2(r2) && i(r2) ? { scrollLeft: (a2 = r2).scrollLeft, scrollTop: a2.scrollTop } : f(r2)), i(t3) ? ((g2 = u(t3, true)).x += t3.clientLeft, g2.y += t3.clientTop) : h2 && (g2.x = y(h2))), { x: m2.left + b2.scrollLeft - g2.x, y: m2.top + b2.scrollTop - g2.y, width: m2.width, height: m2.height };
            }
            function b(e3) {
            ...
            function g(e3) {
              return p(e3) === "html" ? e3 : e3.assignedSlot || e3.parentNode || (a(e3) ? e3.host : null) || d(e3);
            }
            function w(e3) {
            ...
            function O(e3, t3) {
              var o3;
              t3 === void 0 && (t3 = []);
              var r2 = w(e3), i2 = r2 === ((o3 = e3.ownerDocument) == null ? void 0 : o3.body), a2 = n2(r2), s2 = i2 ? [a2].concat(a2.visualViewport || [], v(r2) ? r2 : []) : r2, c2 = t3.concat(s2);
            ...
            function x(e3) {
              return i(e3) && h(e3).position !== "fixed" ? e3.offsetParent : null;
            }
            function _(e3) {
              for (var t3 = n2(e3), o3 = x(e3); o3 && S(o3) && h(o3).position === "static"; )
                o3 = x(o3);
              return o3 && (p(o3) === "html" || p(o3) === "body" && h(o3).position === "static") ? t3 : o3 || function(e4) {
                var t4 = navigator.userAgent.toLowerCase().indexOf("firefox") !== -1;
                if (navigator.userAgent.indexOf("Trident") !== -1 && i(e4) && h(e4).position === "fixed")
                  return null;
                for (var o4 = g(e4); i(o4) && ["html", "body"].indexOf(p(o4)) < 0; ) {
                  var n3 = h(o4);
                  if (n3.transform !== "none" || n3.perspective !== "none" || n3.contain === "paint" || ["transform", "perspective"].indexOf(n3.willChange) !== -1 || t4 && n3.willChange === "filter" || t4 && n3.filter && n3.filter !== "none")
                    return o4;
                  o4 = o4.parentNode;
                }
                return null;
            ...
            function W(e3) {
              e3 === void 0 && (e3 = {});
              var t3 = e3, o3 = t3.defaultModifiers, n3 = o3 === void 0 ? [] : o3, i2 = t3.defaultOptions, a2 = i2 === void 0 ? M : i2;
              return function(e4, t4, o4) {
                ...
                var i3, s2, c2 = { placement: "bottom", orderedModifiers: [], options: Object.assign({}, M, a2), modifiersData: {}, elements: { reference: e4, popper: t4 }, attributes: {}, styles: {} }, l2 = [], u2 = false, f2 = { state: c2, setOptions: function(o5) {
                  var i4 = typeof o5 == "function" ? o5(c2.options) : o5;
                  ...
                  return c2.orderedModifiers = d2.filter(function(e5) {
                    ...
                    var t5 = e5.name, o6 = e5.options, n4 = o6 === void 0 ? {} : o6, r2 = e5.effect;
                  ...
                  if (!u2) {
                    ...
                    if (V(t5, o5)) {
                      c2.rects = { reference: m(t5, _(o5), c2.options.strategy === "fixed"), popper: b(o5) }, c2.reset = false, c2.placement = c2.options.placement, c2.orderedModifiers.forEach(function(e6) {
                        return c2.modifiersData[e6.name] = Object.assign({}, e6.data);
                      });
                      for (var n4 = 0; n4 < c2.orderedModifiers.length; n4++)
                        if (c2.reset !== true) {
                          var r2 = c2.orderedModifiers[n4], i4 = r2.fn, a3 = r2.options, s3 = a3 === void 0 ? {} : a3, l3 = r2.name;
                          typeof i4 == "function" && (c2 = i4({ state: c2, options: s3, name: l3, instance: f2 }) || c2);
                        } else
                          c2.reset = false, n4 = -1;
                    }
                  }
            ...
            function X(e3) {
              var t3, o3 = e3.popper, r2 = e3.popperRect, i2 = e3.placement, a2 = e3.variation, s2 = e3.offsets, c2 = e3.position, u2 = e3.gpuAcceleration, f2 = e3.adaptive, p2 = e3.roundOffsets, y2 = e3.isFixed, v2 = s2.x, m2 = v2 === void 0 ? 0 : v2, b2 = s2.y, g2 = b2 === void 0 ? 0 : b2, w2 = typeof p2 == "function" ? p2({ x: m2, y: g2 }) : { x: m2, y: g2 };
              m2 = w2.x, g2 = w2.y;
              var O2 = s2.hasOwnProperty("x"), S2 = s2.hasOwnProperty("y"), x2 = P, L2 = E, A2 = window;
              if (f2) {
                var T2 = _(o3), q2 = "clientHeight", R2 = "clientWidth";
                T2 === n2(o3) && h(T2 = d(o3)).position !== "static" && c2 === "absolute" && (q2 = "scrollHeight", R2 = "scrollWidth"), T2 = T2, (i2 === E || (i2 === P || i2 === j) && a2 === C) && (L2 = k, g2 -= (y2 && A2.visualViewport ? A2.visualViewport.height : T2[q2]) - r2.height, g2 *= u2 ? 1 : -1), i2 !== P && (i2 !== E && i2 !== k || a2 !== C) || (x2 = j, m2 -= (y2 && A2.visualViewport ? A2.visualViewport.width : T2[R2]) - r2.width, m2 *= u2 ? 1 : -1);
              }
              var D2, H2 = Object.assign({ position: c2 }, f2 && F), B2 = p2 === true ? function(e4) {
            ...
            function te(e3, t3) {
              return t3 === q ? ee(function(e4) {
                ...
                var t4, o3 = d(e4), n3 = f(e4), r2 = (t4 = e4.ownerDocument) == null ? void 0 : t4.body, i2 = s(o3.scrollWidth, o3.clientWidth, r2 ? r2.scrollWidth : 0, r2 ? r2.clientWidth : 0), a2 = s(o3.scrollHeight, o3.clientHeight, r2 ? r2.scrollHeight : 0, r2 ? r2.clientHeight : 0), c2 = -n3.scrollLeft + y(e4), l2 = -n3.scrollTop;
                return h(r2 || o3).direction === "rtl" && (c2 += s(o3.clientWidth, r2 ? r2.clientWidth : 0) - i2), { width: i2, height: a2, x: c2, y: l2 };
              }(d(e3)));
            }
            function oe(e3) {
            ...
            function re(e3, t3) {
              t3 === void 0 && (t3 = {});
              var o3 = t3, n3 = o3.placement, a2 = n3 === void 0 ? e3.placement : n3, l2 = o3.boundary, f2 = l2 === void 0 ? "clippingParents" : l2, y2 = o3.rootBoundary, v2 = y2 === void 0 ? q : y2, m2 = o3.elementContext, b2 = m2 === void 0 ? R : m2, w2 = o3.altBoundary, S2 = w2 !== void 0 && w2, x2 = o3.padding, P2 = x2 === void 0 ? 0 : x2, L2 = oe(typeof P2 != "number" ? P2 : ne(P2, A)), T2 = b2 === R ? "reference" : R, C2 = e3.rects.popper, D2 = e3.elements[S2 ? T2 : b2], H2 = function(e4, t4, o4) {
                var n4 = t4 === "clippingParents" ? function(e5) {
                  var t5 = O(g(e5)), o5 = ["absolute", "fixed"].indexOf(h(e5).position) >= 0 && i(e5) ? _(e5) : e5;
                  return r(o5) ? t5.filter(function(e6) {
                    return r(e6) && Q(e6, o5) && p(e6) !== "body";
                  }) : [];
            ...
            function ae(e3, t3, o3) {
              return o3 === void 0 && (o3 = { x: 0, y: 0 }), { top: e3.top - t3.height - o3.y, right: e3.right - t3.width + o3.x, bottom: e3.bottom - t3.height + o3.y, left: e3.left - t3.width - o3.x };
            }
            function se(e3) {
            ...
            var ce = W({ defaultModifiers: [{ name: "eventListeners", enabled: true, phase: "write", fn: function() {
              ...
              var t3 = e3.state, o3 = e3.instance, r2 = e3.options, i2 = r2.scroll, a2 = i2 === void 0 || i2, s2 = r2.resize, c2 = s2 === void 0 || s2, l2 = n2(t3.elements.popper), u2 = [].concat(t3.scrollParents.reference, t3.scrollParents.popper);
              ...
              var t3 = e3.state, o3 = e3.options, n3 = o3.gpuAcceleration, r2 = n3 === void 0 || n3, i2 = o3.adaptive, a2 = i2 === void 0 || i2, s2 = o3.roundOffsets, c2 = s2 === void 0 || s2, l2 = { placement: N(t3.placement), variation: Z(t3.placement), popper: t3.elements.popper, popperRect: t3.rects.popper, gpuAcceleration: r2, isFixed: t3.options.strategy === "fixed" };
              t3.modifiersData.popperOffsets != null && (t3.styles.popper = Object.assign({}, t3.styles.popper, X(Object.assign({}, l2, { offsets: t3.modifiersData.popperOffsets, position: t3.options.strategy, adaptive: a2, roundOffsets: c2 })))), t3.modifiersData.arrow != null && (t3.styles.arrow = Object.assign({}, t3.styles.arrow, X(Object.assign({}, l2, { offsets: t3.modifiersData.arrow, position: "absolute", adaptive: false, roundOffsets: c2 })))), t3.attributes.popper = Object.assign({}, t3.attributes.popper, { "data-popper-placement": t3.placement });
              ...
              Object.keys(t3.elements).forEach(function(e4) {
                ...
                i(r2) && p(r2) && (Object.assign(r2.style, o3), Object.keys(n3).forEach(function(e5) {
                  var t4 = n3[e5];
                  t4 === false ? r2.removeAttribute(e5) : r2.setAttribute(e5, t4 === true ? "" : t4);
                }));
              });
            }, effect: function(e3) {
              ...
              var t3 = e3.state, o3 = e3.options, n3 = e3.name, r2 = o3.offset, i2 = r2 === void 0 ? [0, 0] : r2, a2 = H.reduce(function(e4, o4) {
                return e4[o4] = function(e5, t4, o5) {
                  var n4 = N(e5), r3 = [P, E].indexOf(n4) >= 0 ? -1 : 1, i3 = typeof o5 == "function" ? o5(Object.assign({}, t4, { placement: e5 })) : o5, a3 = i3[0], s3 = i3[1];
                  return a3 = a3 || 0, s3 = (s3 || 0) * r3, [P, j].indexOf(n4) >= 0 ? { x: s3, y: a3 } : { x: a3, y: s3 };
                }(o4, t3.rects, i2), e4;
              }, {}), s2 = a2[t3.placement], c2 = s2.x, l2 = s2.y;
              t3.modifiersData.popperOffsets != null && (t3.modifiersData.popperOffsets.x += c2, t3.modifiersData.popperOffsets.y += l2), t3.modifiersData[n3] = a2;
            } }, { name: "flip", enabled: true, phase: "main", fn: function(e3) {
              var t3 = e3.state, o3 = e3.options, n3 = e3.name;
              if (!t3.modifiersData[n3]._skip) {
                for (var r2 = o3.mainAxis, i2 = r2 === void 0 || r2, a2 = o3.altAxis, s2 = a2 === void 0 || a2, c2 = o3.fallbackPlacements, l2 = o3.padding, u2 = o3.boundary, f2 = o3.rootBoundary, p2 = o3.altBoundary, d2 = o3.flipVariations, y2 = d2 === void 0 || d2, h2 = o3.allowedAutoPlacements, v2 = t3.options.placement, m2 = N(v2), b2 = c2 || (m2 !== v2 && y2 ? function(e4) {
                  if (N(e4) === L)
                    return [];
                  var t4 = G(e4);
                  return [K(e4), t4, K(t4)];
                  ...
                  return e4.concat(N(o4) === L ? function(e5, t4) {
                    t4 === void 0 && (t4 = {});
                    var o5 = t4, n4 = o5.placement, r3 = o5.boundary, i3 = o5.rootBoundary, a3 = o5.padding, s3 = o5.flipVariations, c3 = o5.allowedAutoPlacements, l3 = c3 === void 0 ? H : c3, u3 = Z(n4), f3 = u3 ? s3 ? D : D.filter(function(e6) {
                      return Z(e6) === u3;
                ...
                }, []), w2 = t3.rects.reference, O2 = t3.rects.popper, S2 = new Map(), x2 = true, _2 = g2[0], C2 = 0; C2 < g2.length; C2++) {
              ...
              var t3 = e3.state, o3 = e3.options, n3 = e3.name, r2 = o3.mainAxis, i2 = r2 === void 0 || r2, a2 = o3.altAxis, l2 = a2 !== void 0 && a2, u2 = o3.boundary, f2 = o3.rootBoundary, p2 = o3.altBoundary, d2 = o3.padding, y2 = o3.tether, h2 = y2 === void 0 || y2, v2 = o3.tetherOffset, m2 = v2 === void 0 ? 0 : v2, g2 = re(t3, { boundary: u2, rootBoundary: f2, padding: d2, altBoundary: p2 }), w2 = N(t3.placement), O2 = Z(t3.placement), S2 = !O2, x2 = U(w2), L2 = x2 === "x" ? "y" : "x", A2 = t3.modifiersData.popperOffsets, C2 = t3.rects.reference, q2 = t3.rects.popper, R2 = typeof m2 == "function" ? m2(Object.assign({}, t3.rects, { placement: t3.placement })) : m2, D2 = typeof R2 == "number" ? { mainAxis: R2, altAxis: R2 } : Object.assign({ mainAxis: 0, altAxis: 0 }, R2), H2 = t3.modifiersData.offset ? t3.modifiersData.offset[t3.placement] : null, B2 = { x: 0, y: 0 };
              if (A2) {
                if (i2) {
                  var I2, M2 = x2 === "y" ? E : P, V2 = x2 === "y" ? k : j, W2 = x2 === "y" ? "height" : "width", $2 = A2[x2], z2 = $2 + g2[M2], F2 = $2 - g2[V2], X2 = h2 ? -q2[W2] / 2 : 0, Y2 = O2 === T ? C2[W2] : q2[W2], G2 = O2 === T ? -q2[W2] : -C2[W2], J2 = t3.elements.arrow, K2 = h2 && J2 ? b(J2) : { width: 0, height: 0 }, Q2 = t3.modifiersData["arrow#persistent"] ? t3.modifiersData["arrow#persistent"].padding : { top: 0, right: 0, bottom: 0, left: 0 }, ee2 = Q2[M2], te2 = Q2[V2], oe2 = ie(0, C2[W2], K2[W2]), ne2 = S2 ? C2[W2] / 2 - X2 - oe2 - ee2 - D2.mainAxis : Y2 - oe2 - ee2 - D2.mainAxis, ae2 = S2 ? -C2[W2] / 2 + X2 + oe2 + te2 + D2.mainAxis : G2 + oe2 + te2 + D2.mainAxis, se2 = t3.elements.arrow && _(t3.elements.arrow), ce2 = se2 ? x2 === "y" ? se2.clientTop || 0 : se2.clientLeft || 0 : 0, le = (I2 = H2 == null ? void 0 : H2[x2]) != null ? I2 : 0, ue = $2 + ae2 - le, fe = ie(h2 ? c(z2, $2 + ne2 - le - ce2) : z2, $2, h2 ? s(F2, ue) : F2);
                  A2[x2] = fe, B2[x2] = fe - $2;
                }
                if (l2) {
                  var pe, de = x2 === "x" ? E : P, ye = x2 === "x" ? k : j, he = A2[L2], ve = L2 === "y" ? "height" : "width", me = he + g2[de], be = he - g2[ye], ge = [E, P].indexOf(w2) !== -1, we = (pe = H2 == null ? void 0 : H2[L2]) != null ? pe : 0, Oe = ge ? me : he - C2[ve] - q2[ve] - we + D2.altAxis, Se = ge ? he + C2[ve] + q2[ve] - we - D2.altAxis : be, xe = h2 && ge ? function(e4, t4, o4) {
                    var n4 = ie(e4, t4, o4);
                    return n4 > o4 ? o4 : n4;
              ...
              if (i2 && a2) {
                var u2 = function(e4, t4) {
                  return oe(typeof (e4 = typeof e4 == "function" ? e4(Object.assign({}, t4.rects, { placement: t4.placement })) : e4) != "number" ? e4 : ne(e4, A));
                }(r2.padding, o3), f2 = b(i2), p2 = c2 === "y" ? E : P, d2 = c2 === "y" ? k : j, y2 = o3.rects.reference[l2] + o3.rects.reference[c2] - a2[c2] - o3.rects.popper[l2], h2 = a2[c2] - o3.rects.reference[c2], v2 = _(i2), m2 = v2 ? c2 === "y" ? v2.clientHeight || 0 : v2.clientWidth || 0 : 0, g2 = y2 / 2 - h2 / 2, w2 = u2[p2], O2 = m2 - f2[l2] - u2[d2], S2 = m2 / 2 - f2[l2] / 2 + g2, x2 = ie(w2, S2, O2), L2 = c2;
                o3.modifiersData[n3] = ((t3 = {})[L2] = x2, t3.centerOffset = x2 - S2, t3);
              }
            }, effect: function(e3) {
              var t3 = e3.state, o3 = e3.options.element, n3 = o3 === void 0 ? "[data-popper-arrow]" : o3;
              n3 != null && (typeof n3 != "string" || (n3 = t3.elements.popper.querySelector(n3))) && Q(t3.elements.popper, n3) && (t3.elements.arrow = n3);
  ...
  // resources/js/app.js
  Promise.resolve().then(() => __toModule(require_preline()));
    ...
    menuItemsWithSubmenu.forEach((menuItem) => {
      menuItem.addEventListener("click", function(e) {
        ...
        allSubmenus.forEach((submenu2) => {
          if (submenu2 !== menuItem.nextElementSibling) {
